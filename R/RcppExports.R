...
ML_theta_c <- function(score, b, a, first, last) {
    .Call(`_dexter_ML_theta_c`, score, b, a, first, last)
}

deriv_theta_c <- function(theta, b, a, first, last, n_cores = 1L) {
...
theta_jeap_c <- function(grid, b, a, first, last, bk_nit, n_cores = 1L) {
    .Call(`_dexter_theta_jeap_c`, grid, b, a, first, last, bk_nit, n_cores)
}

theta_eap_c <- function(grid, weights, b, a, first, last, bk_nit, n_cores = 1L) {
