...
```{r, figProf, echo=FALSE, results="hide",fig.height=4,fig.width=4,fig.align='center',message=FALSE}
...
```{r, fig1, echo=FALSE,fig.align='center', out.extra='style="margin-left: -30px; margin-top: -45px;"'}
...
Joint
<div class='crop'>
```{r, fig21, echo=FALSE, out.extra='style="margin-left: -30px; margin-top: -50px;"'}
joint = prop.table(fq)
...
Conditional
<div class='crop'>
```{r, fig22, echo=FALSE, out.extra='style="margin-left: -30px; margin-top: -50px;"'}
...
Special
<div class='crop' style='margin:auto;'>
```{r, fig3, echo=FALSE,out.extra='style="margin-left: -30px; margin-top: -50px;"'}
special = fq / den
...
```{r, fig41, echo=FALSE,out.extra='style="margin-left: -30px; margin-top: -50px;"'}
pa=reds(5)
hi = c(1,4,5,6,9)
sp[hi] = pa[j[hi]]
...
<div class='crop'>
```{r, fig42, echo=FALSE,out.extra='style="margin-top: -30px;margin-left:0px;"'}
...
```{r, prof_plot2, echo=FALSE, fig.height=5, fig.width=5, fig.align='center'}
...
Note that the profile plots got their name from their similarity to *profile analysis* which was proposed by Norman Verhelst [@VerhelstPA] and suggested by him and his co-workers as a method to test for DIF [@Yildirim14]. Profile analysis will become available in dexter in the near future. 
